...
public class DefaultConsent implements Consent
{
     ...
     */
    public DefaultConsent(String id, String label, String description, boolean required, List<String> dataFields, List<String> formFields)
    {
        this.id = id;
        this.label = label;
    ...
    public Consent copy(ConsentStatus status)
    {
        Consent copy = new DefaultConsent(
            this.getId(), this.getLabel(), this.getDescription(), this.isRequired(), this.getDataFields(), this.getFields());
