...
public class DefaultConsentTest
{
    ...
    public void fieldFunctionsWork()
    {
        ...
        Consent consent1 = new DefaultConsent(ID_STRING, LABEL_STRING, DESCRIPTION_STRING, required, DATA_FIELDS, FORM_FIELDS);
        Assert.assertFalse(consent1.affectsAllFields());
        Assert.assertTrue(consent1.affectsSomeFields());

        Consent consent2 = new DefaultConsent(ID_STRING, LABEL_STRING, DESCRIPTION_STRING, required, DATA_FIELDS_ALL, FORM_FIELDS_ALL);
    ...
    public void copiesCorrectly()
    {
        ...
        boolean required = false;
        Consent original = new DefaultConsent(ID_STRING, LABEL_STRING, DESCRIPTION_STRING, required, DATA_FIELDS, FORM_FIELDS);
    ...
    public void producesCorrectJson()
    {
        ConsentStatus status = ConsentStatus.NO;
        boolean required = false;
        Consent consent = new DefaultConsent(ID_STRING, LABEL_STRING, DESCRIPTION_STRING, required, DATA_FIELDS, FORM_FIELDS);
