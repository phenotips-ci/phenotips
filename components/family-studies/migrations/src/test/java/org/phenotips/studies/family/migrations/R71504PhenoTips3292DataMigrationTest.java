...
/**
 * Unit tests for {@link R71504PhenoTips3292DataMigration}.
 */
public class R71504PhenoTips3292DataMigrationTest
{
    ...
    private static final String PEDIGREE_1_DATA = "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000001\"},\"id\":0},"
        ...
        + "\"settings\":{\"legendSettings\":{\"abnormalities\":{\"cancers\":{\"Breast\":{\"color\": \"#e267a3\"},"
        + "\"Ovarian\":{\"color\":\"#9370DB\"}}}}}}";
    ...
    private static final String PEDIGREE_2_DATA = "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000004\"},\"id\":0},"
        ...
        + "{\"legendSettings\":{\"abnormalities\":{\"cancers\":{}}}}}";
    ...
    private static final String PEDIGREE_3_DATA = "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000007\",\"cancers\":"
        ...
        + "false}}},\"id\":0}],\"settings\":{\"legendSettings\":{\"abnormalities\":{\"cancers\":{\"Kidney\":"
        + "{\"color\":\"#e267a3\"}}}}}}";
    ...
    private static final String PEDIGREE_1_MIGRATED_DATA = "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000001\"},"
        ...
        + "\"notes\":\"\"}]}]},\"id\":4}],\"settings\":{\"legendSettings\":{\"abnormalities\":{\"cancers\": "
        + "{\"HP:0100013\":{\"color\":\"#e267a3\"},\"HP:0100615\":{\"color\":\"#9370DB\"}}}}}}";
    ...
    private static final String PEDIGREE_2_MIGRATED_DATA = "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000004\"},"
        ...
        + ",\"settings\":{\"legendSettings\":{\"abnormalities\":{\"cancers\":{}}}}}";
    ...
    private static final String PEDIGREE_3_MIGRATED_DATA =
        "{\"GG\":[{\"prop\":{\"phenotipsId\":\"P0000007\",\"cancers\":[{\"id\":\"HP:0009726\",\"label\":\"Kidney\","
            ...
            + "\"primary\":true,\"notes\":\"\"}]}]},\"id\":0}],\"settings\":{\"legendSettings\":{\"abnormalities\":"
            + "{\"cancers\":{\"HP:0009726\":{\"color\":\"#e267a3\"}}}}}}";

    @Rule
    public MockitoComponentMockingRule<HibernateDataMigration> mocker =
        new MockitoComponentMockingRule<>(R71504PhenoTips3292DataMigration.class, HibernateDataMigration.class,
            "R71504-PT-3292");
    ...
    private R71504PhenoTips3292DataMigration component;
    ...
    public void setUp() throws Exception
    {
        ...
        this.component = (R71504PhenoTips3292DataMigration) this.mocker.getComponentUnderTest();
    ...
    public void doInHibernateBehavesAsExpectedForPedigreeWithOnePatientWithOneCancer() throws XWikiException
    {
        ...
        verify(this.store, times(1)).saveXWikiDoc(this.xDocument3, this.context, false);
    }
        ...
        throws XWikiException
    {
        ...
        verify(this.store, times(1)).saveXWikiDoc(this.xDocument1, this.context, false);
        verify(this.store, never()).saveXWikiDoc(this.xDocument2, this.context, false);
        verify(this.store, times(1)).saveXWikiDoc(this.xDocument3, this.context, false);
    }
    ...
    {
        Assert.assertEquals(0, new XWikiDBVersion(71504).compareTo(this.component.getVersion()));
    }
