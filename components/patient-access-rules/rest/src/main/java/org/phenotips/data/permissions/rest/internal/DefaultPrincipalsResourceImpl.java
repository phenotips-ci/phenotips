...
public class DefaultPrincipalsResourceImpl extends XWikiResource implements PrincipalsResource
{
    ...
    @Override
    public PrincipalsRepresentation getPrincipals(String patientId)
    {
        this.logger.debug("Retrieving principals with access to patient record [{}] via REST", patientId);
        ...
        PrincipalsRepresentation result =
            this.factory.createPrincipalsRepresentation(patientAccessContext.getPatient(), this.uriInfo);
