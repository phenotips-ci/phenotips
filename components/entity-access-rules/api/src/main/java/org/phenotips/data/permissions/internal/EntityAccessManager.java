...
public interface EntityAccessManager
{
    ...
    @Nonnull
    AccessLevel getAccessLevel(@Nonnull PrimaryEntity entity, @Nullable EntityReference userOrGroup);
     ...
     */
    boolean isAdministrator(@Nonnull PrimaryEntity entity);
     ...
     */
    boolean isAdministrator(@Nonnull PrimaryEntity entity, @Nullable DocumentReference user);
     ...
     */
    @Nonnull
    Owner getOwner(@Nonnull PrimaryEntity entity);
     ...
     */
    boolean setOwner(@Nonnull PrimaryEntity entity, @Nullable EntityReference userOrGroup);

    @Nonnull
    Collection<Collaborator> getCollaborators(@Nonnull PrimaryEntity entity);

    boolean setCollaborators(@Nonnull PrimaryEntity entity, @Nullable Collection<Collaborator> newCollaborators);

    boolean addCollaborator(@Nonnull PrimaryEntity entity, @Nullable Collaborator collaborator);

    boolean removeCollaborator(@Nonnull PrimaryEntity entity, @Nullable Collaborator collaborator);
}
